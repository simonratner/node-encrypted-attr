...
function EncryptedAttributes (attributes, options) {
  ...
  if (!isNativeCryptoFullyCapable) {
    throw new Error('Current installed node version\'s native `crypto` module is not fully capable of the necessary functionality for encrypting attributes.  Please upgrade to Node v' + MIN_NODE_VERSION + ' or above, flush your node_modules, run npm install, and then try again.')
  }
